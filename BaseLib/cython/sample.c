 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_t_5 = (((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_4 * __pyx_v_a.strides[0]) ))) < __pyx_v_min) != 0);
    if (__pyx_t_5) {
 ...
 */
    __pyx_t_7 = __pyx_v_i;
    __pyx_t_5 = (((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_7 * __pyx_v_a.strides[0]) ))) > __pyx_v_max) != 0);
    if (__pyx_t_5) {
...
static PyMethodDef __pyx_methods[] = {
  {"clip", (PyCFunction)__pyx_pw_6sample_1clip, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
